...
// EnsureTargetProxy ensures that the required target proxies exist for the given ports.
...
func (s *TargetProxySyncer) updateHttpTargetProxy(desiredHttpProxy *compute.TargetHttpProxy) (string, error) {
	...
	// Apart from name, TargetProxy is the only field that be different. We update that field directly.
